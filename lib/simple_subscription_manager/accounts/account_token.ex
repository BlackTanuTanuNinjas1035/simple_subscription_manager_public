defmodule SimpleSubscriptionManager.Accounts.AccountToken do
  use Ecto.Schema
  import Ecto.Query
  alias SimpleSubscriptionManager.Accounts.AccountToken
  ...
  schema "accounts_tokens" do
    ...
    belongs_to :account, SimpleSubscriptionManager.Accounts.Account
