...
config :simple_subscription_manager, SimpleSubscriptionManagerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vQxNZWYYcIfZq1kzb3pvarxs0t0/s+hDAOhoiJB+Fgu0bqWRYLZiQgDBe5mnlb0m",
  watchers: [
...
config :simple_subscription_manager, SimpleSubscriptionManagerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/simple_subscription_manager_web/(live|views)/.*(ex)$",
      ~r"lib/simple_subscription_manager_web/templates/.*(eex)$"
    ]
  ]
