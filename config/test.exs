...
config :simple_subscription_manager, SimpleSubscriptionManager.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "simple_subscription_manager_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :simple_subscription_manager, SimpleSubscriptionManagerWeb.Endpoint,
  ...
  secret_key_base: "efm9hA1gPKm9iWottaNikiik/m9PitSZVxw99LywU6A+cxnFNRn0ODotCYaXQfj/",
  server: false
