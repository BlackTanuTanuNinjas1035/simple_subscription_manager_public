defmodule SimpleSubscriptionManager.AccountsTest do
  use SimpleSubscriptionManager.DataCase

  alias SimpleSubscriptionManager.Accounts

  import SimpleSubscriptionManager.AccountsFixtures
  alias SimpleSubscriptionManager.Accounts.{Account, AccountToken}
