defmodule SimpleSubscriptionManagerWeb.AccountAuthTest do
  ...
  @remember_me_cookie "_simple_subscription_manager_web_account_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SimpleSubscriptionManagerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SimpleSubscriptionManagerWeb.Endpoint.subscribe(live_socket_id)
