defmodule SimpleSubscriptionManager.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `SimpleSubscriptionManager.Accounts` context.
  """
  ...
  def account_fixture(attrs \\ %{}) do
    {:ok, account} =
      ...
      |> SimpleSubscriptionManager.Accounts.register_account()
